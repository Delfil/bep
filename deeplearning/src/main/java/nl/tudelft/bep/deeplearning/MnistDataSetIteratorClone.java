 ...
 * @author Adam Gibson
 */
public class MnistDataSetIteratorClone extends BaseDatasetIterator {

	public MnistDataSetIteratorClone(int batch,int numExamples) throws IOException {
     ...
     * @throws IOException
     */
    public MnistDataSetIteratorClone(int batch, int numExamples, boolean binarize) throws IOException {
     ...
     * @throws IOException
     */
    public MnistDataSetIteratorClone(int batchSize, boolean train, int seed) throws IOException{
        this(batchSize, (train ? DataFetcherClone.NUM_EXAMPLES : DataFetcherClone.NUM_EXAMPLES_TEST), false, train, true, seed);
    }
     ...
     */
    public MnistDataSetIteratorClone(int batch, int numExamples, boolean binarize, boolean train, boolean shuffle, long rngSeed) throws IOException {
        super(batch, numExamples,new DataFetcherClone(binarize,train,shuffle,rngSeed));
    }
