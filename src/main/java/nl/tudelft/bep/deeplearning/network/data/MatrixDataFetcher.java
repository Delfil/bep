...
public class MatrixDataFetcher extends BaseDataFetcher {
	 ...
	 * 
	 * @param data
	 *            The {@link GeneExpressionDatabaseI} instance to fetch from
	 * @param start
	 *            The percentage of examples to skip from the left
	 * @param end
	 *            The percentage of examples to skip from the right
	 */
	public MatrixDataFetcher(final GeneExpressionDatabaseI data, final double start, final double end) {
